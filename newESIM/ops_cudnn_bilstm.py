...
def cudnn_lstm(num_layers, hidden_size,scope=None):
    """Run the CuDNN LSTM.
    Arguments:
...
def call_cudnn_lstm(inputs, num_layers, hidden_size,cudnn_cell):
