...
def label_input(true_label,pred_label,pred_prob,cos_dis,input_file,output_file):
  '''
  '''
  if len(true_label) != len(pred_label):
    ...
    for i in range (data_num):
      ...
      out_line = "true:"+ str(true_label[i]) + "\tpred:"+ str(pred_label[i])+ "\t"+ "%.4f"%(cos_dis[i])  +"\t"+ '%.4f'%(pred_prob[i][0])+"\t"+ '%.4f'%(pred_prob[i][1])+"\t"+ '%.4f'%(pred_prob[i][2])+"\t"+ str(input_txt[i][:-2])+"\t"+ str(input_txt[i][-1])  +"\n"
      #out_line = "true:"+ str(true_label[i]) + "\tpred:"+ str(pred_label[i])+"\t"+ '%.4f'%(pred_prob[i][0])+"\t"+ '%.4f'%(pred_prob[i][1])+"\t"+ '%.4f'%(pred_prob[i][2])+"\t"+ str(input_txt[i][:-2])+"\t"+ str(input_txt[i][-1])  +"\n"
