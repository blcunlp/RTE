class SmallConfig(object):
  ...
  lemma_train_file="../data/lemma/lemma_train.txt"
  lemma_dev_file="../data/lemma/lemma_dev.txt"
  lemma_test_file="../data/lemma/lemma_test.txt"
...
class TestConfig(object):
  ...
  lemma_train_file="../data/lemma/lemma_train_100.txt"
  lemma_dev_file="../data/lemma/lemma_dev_10.txt"
  lemma_test_file="../data/lemma/lemma_test_10.txt"
