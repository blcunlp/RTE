...
def confuse_matrix(true_label_total,pred_label_total,config):
  #print("\n\n\nconfuseMatric\n\n\n");
  ...
  #if config.dataset_name != "scitail":
  if config.num_classes==3: 
    confmx = """label \ predict | neutral | entailment | contradiction
      -------------------------------------------------------
      neutral        |     {:.3f}     |    {:.3f}   |    {:.3f}        
      entailment     |     {:.3f}     |    {:.3f}   |    {:.3f}         
      contradiction  |     {:.3f}     |    {:.3f}   |    {:.3f}         """.format(\
        confuse_m_normalize[0][0],confuse_m_normalize[0][1],confuse_m_normalize[0][2],\
        confuse_m_normalize[1][0],confuse_m_normalize[1][1],confuse_m_normalize[1][2],\
        confuse_m_normalize[2][0],confuse_m_normalize[2][1],confuse_m_normalize[2][2])
  else:
    confmx = """label \ predict | neutral | entailment 
      -------------------------------------------------------
      neutral        |     {:.3f}     |    {:.3f}          
      entailment     |     {:.3f}     |    {:.3f}            """.format(\
        confuse_m_normalize[0][0],confuse_m_normalize[0][1],\
        confuse_m_normalize[1][0],confuse_m_normalize[1][1])
  return confmx
